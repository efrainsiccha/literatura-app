package com.literatura.literatura_app.main;

import com.literatura.literatura_app.model.Autor;
import com.literatura.literatura_app.model.Book;
import com.literatura.literatura_app.model.BookData;
import com.literatura.literatura_app.model.Data;
...
import com.literatura.literatura_app.service.ConsumoAPI;
import com.literatura.literatura_app.service.Conversor;
...
public class main {
    ...
    public main(BookRepository bookRepository, AutorRepository authorRepository) {
    ...
    public List<BookData> getPopularBookData() {
        // la API por defecto trae lo más populares; sin embargo añadimos la query..
    ...
    public void searchBookByTitle() {
        ...
        if (dbBook.isPresent()) {
            ...
            List<Autor> authorList = apiBook.get().authors().stream()
                    .map(a -> authorRepository.findByNameContainsIgnoreCase(a.name())
                            .orElseGet(() -> authorRepository.save(new Autor(a))))
    ...
    public void getAllAuthors() {
        List<Autor> dbAuthors = authorRepository.findAll();
    ...
    public void getAuthorsByLiveDate() {
        ...
        List<Autor> filteredAuthors = authorRepository.filterAuthorsByYear(year);
    ...
    public void getAuthorByName() {
        ...
        Optional<Autor> dbAuthor = authorRepository.findByNameContainsIgnoreCase(authorName);
